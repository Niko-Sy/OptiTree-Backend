...
const (
	...
	CodeAgentSessionNotFound = 40410
	CodeAgentSessionTimeout  = 40810
	CodeAgentMaxToolCalls    = 42910
	CodeAgentToolError       = 42210
	CodeAgentSafetyBlocked   = 40310
)
...
const (
	...
	MsgAgentSessionNotFound = "Agent 会话不存在"
	MsgAgentSessionTimeout  = "Agent 会话等待超时"
	MsgAgentMaxToolCalls    = "Agent 工具调用次数超限"
	MsgAgentToolError       = "Agent 工具执行失败"
	MsgAgentSafetyBlocked   = "Agent 安全策略拦截"
)
